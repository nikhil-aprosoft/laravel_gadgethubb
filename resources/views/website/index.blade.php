...
<body class="home">
                        ...
                        <div class="product product-single row">
                                ...
                                <div class="product-gallery product-gallery-sticky product-gallery-vertical">
                                    <div class="swiper-container product-single-swiper swiper-theme nav-inner">
                                        ...
                                        <div class="product-label-group">
                                            @if($dd->discount)
                                                <label class="product-label label-discount">{{ $dd->discount }}% Off</label>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="product-details scrollable">
                                    <h2 class="product-title mb-1"><a href="">{{ $dd->text }}</a></h2>
                                    <hr class="product-divider">
                                    <div class="product-price">
                                        <ins class="new-price ls-50">{{ $dd['product']->price }}</ins>
                                    </div>
                                    <!-- Countdown timer can be implemented if needed -->
                                    <div class="product-countdown-container flex-wrap">
                                        <label class="mr-2 text-default">Offer Ends In:
                                            <span class="countdown-row countdown-amount">{{getDealExpireTime($dd)}}</span>
                                    </label>
                                    ...
                                    <div class="product-form product-variation-form product-size-swatch mb-3">
                                        ...
                                        <div class="flex-wrap d-flex align-items-center product-variations">
                                            ...
                                            <a href="#" class="size">{{$productSize}}</a>
                                            @endforeach
                                        </div>
                ...
                <div class="swiper-container swiper-theme pg-show"
                    ...
                    ?>
                            ...
                            <div class="category-content">
                                ...
                                <a href="{{ url('category/' . $cat->slug) }}" class="btn btn-primary btn-link btn-underline">Shop
                                    Now</a>
                            </div>
                        </div>
                        @endforeach
    ...
    <div class="container">
        ...
        <x-tab-nav :tabs="[
            ['id' => 'tab1-1', 'label' => 'New arrivals'],
            ['id' => 'tab1-2', 'label' => 'Best seller'],
            ['id' => 'tab1-3', 'label' => 'Most popular'],
            ['id' => 'tab1-4', 'label' => 'Featured'],
        ]" />
        ...
        <div class="tab-content product-wrapper appear-animate">
            <div class="tab-pane active pt-4" id="tab1-1">
                <x-product-list :products="[
                    [
                        'link' => 'product-default.html',
                        'image1' => 'assets/images/demos/demo1/products/3-1-1.jpg',
                        'image2' => 'assets/images/demos/demo1/products/3-1-2.jpg',
                        'name' => 'Classic Hat',
                        'rating' => 60, 
                        'reviews' => 1,
                        'price' => '$53.00',
