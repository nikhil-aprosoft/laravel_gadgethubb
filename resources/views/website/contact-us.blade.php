                            ...
                            <div class="swiper-wrapper row cols-xl-4 cols-md-3 cols-sm-2 cols-1">
                                <div class="swiper-slide icon-box text-center icon-box-primary">
                                    ...
                                    <div class="icon-box-content">
                                        ...
                                        <p><a href="https://portotheme.com/cdn-cgi/l/email-protection" class="__cf_email__"
                                                data-cfemail="f79a969e9bb7928f969a879b92d994989a">[email&#160;protected]</a>
                                        </p>
                                    </div>
                                </div>
                                <div class="swiper-slide icon-box text-center icon-box-primary">
                    ...
                    <section class="contact-section">
                        <div class="row gutter-lg pb-3">
                            ...
                            <div class="col-lg-6 mb-8">
                                ...
                                <form class="form contact-us-form" action="{{ route('contact') }}" method="post">@csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" id="email_1" name="email" required class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="message">Your Message</label>
                                        <textarea id="message" name="desc" cols="30" required rows="5" class="form-control"></textarea>
                                    </div>
