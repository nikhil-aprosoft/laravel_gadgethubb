                            ...
                            <div class="main-content">
                                <div class="product product-single row">
                                                        ...
                                                        <div class="swiper-slide">
                                                            <figure class="product-image">
                                                                <img src="{{ $product->images[$i] }}"
                                                                    data-zoom-image="{{ $product->pop_images[$i] }}"
                                                ...
                                                <div class="product-thumbs swiper-wrapper row cols-4 gutter-sm">
                                                    @foreach ($product->small_thumbs as $smallThumb)
                                                        <div class="product-thumb swiper-slide">
                                                            <img src="{{ $smallThumb }}" alt="Product Thumb"
                                    ...
                                    <div class="col-md-6 mb-4 mb-md-6">
                                        <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                            ...
                                            <div class="product-price"><ins class="new-price" style="font-family: Arial;">{{ $product->price }}</ins>
                                            </div>
                                    ...
                                    <div class="bought-together-products row mt-8 pb-4">
                                                ...
                                                <figure class="product-media">
                                                    ...
                                                    <div class="product-checkbox">
                                                        <input type="checkbox" class="custom-checkbox"
                                                            id="product_check{{ $loop->index }}"
                                                            data-price="{{ str_replace(['₹', ',', ' '], '', $fbp['product']['price']) }}"
                                                            data-product-name="{{ $fbp['product']['product_name'] }}"
                                                            checked>
                                                        <label for="product_check{{ $loop->index }}"></label>
                                                    </div>
                                                </figure>
                                                <div class="product-details">
                                                    <h4 class="product-name">
                                                        <a href="#">{{ $fbp['product']['product_name'] }}</a>
                                                    </h4>
                                                    <div class="product-price">{{ $fbp['product']['price'] }}
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
                                        <div class="product-button">
                                            <div class="bought-price font-weight-bolder text-primary ls-50"
                                                id="total-price">$0.00</div>
                                            <div class="bought-count" id="item-count">For 0 items</div>
                                            <a href="cart.html" class="btn btn-dark btn-rounded" id="add-to-cart">Add All
                                                To Cart</a>
                                        </div>
                                    </div>
                                </div> --}}
                                <script>
                                    document.addEventListener('DOMContentLoaded', function() {
                                        ...
                                        function updateTotals() {
                                            ...
                                            itemCountElement.textContent = `For ${itemCount} item${itemCount > 1 ? 's' : ''}`;
                                            addToCartButton.disabled = itemCount === 0;
                                        }

                                        // Initialize totals based on the default checked state of checkboxes
                                        updateTotals();
                                ...
                                <div class="tab tab-nav-boxed tab-nav-underline product-tabs">
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        {{-- <li class="nav-item">
                                        <a href="#" class="nav-link">Vendor Info</a>
                                    </li> --}}
                                        {{-- <li class="nav-item">
                                        ...
                                        <div class="tab-pane active" id="product-tab-description">
                                            <div class="row mb-4">
                                                <div class="col-md-6 mb-5">
                                                    <h4 class="title tab-pane-title font-weight-bold mb-2">Details
                                                    </h4>
                                            ...
                                            <div class="row cols-md-3">
                                                <div class="mb-3">
                                                    ...
                                                    <p class="detail pl-5">We offer free shipping for products on
                                                        orders
                                                ...
                                                <div class="mb-3">
                                                    <h5 class="sub-title font-weight-bold"><span>2.</span>Free and
                                                        Easy
                                                        Returns</h5>
                                                    <p class="detail pl-5">We guarantee our products and you could
                                                        get back
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <p class="detail pl-5">Get 20%-50% off items over 50$ for a
                                                        month or
                                        ...
                                        <div class="tab-pane" id="product-tab-reviews">
                                                    ...
                                                    <div class="review-form-wrapper">
                                                        ...
                                                        <form action="#" method="POST" class="review-form">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="checkbox" class="custom-checkbox"
                                                                    id="save-checkbox">
                                                                <label for="save-checkbox">Save my name, email, and
                                                                    website
                                            ...
                                            <div class="tab tab-nav-boxed tab-nav-outline tab-nav-center">
                                                <ul class="nav nav-tabs" role="tablist">
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="#highest-rating" class="nav-link">Highest
                                                            Rating</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a href="#lowest-rating" class="nav-link">Lowest
                                                            Rating</a>
                                                    </li>
                                                </ul>
                                                <div class="tab-content">
                                                                ...
                                                                <div class="comment-body">
                                                                    ...
                                                                    <div class="comment-content">
                                                                        <h4 class="comment-author">
                                                                            <a href="#">John Doe</a>
                                                                            <span class="comment-date">March 22,
                                                                                2021 at
                                                                                1:54 pm</span>
                                                                        </h4>
                                                ...
                                                <div class="swiper-slide product">
                                                    <figure class="product-media">
                                                        ...
                                                        <div class="product-action-vertical">
                                                            <a href="#"
                                                                ...
                                                                title="Add to cart"></a>
                                                            <a href="#"
                                                                onClick="wishList({{ json_encode($item) }})"
                                                    ...
                                                    <div class="product-details">
                                                        ...
                                                        <div class="product-pa-wrapper">
                                                            <div class="product-price" style="font-family: Arial;">{{ $item->price }}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            @endforeach
                                    ...
                                    <div class="sticky-sidebar">
                                        ...
                                        <div class="widget widget-banner mb-9">
                                            <div class="banner banner-fixed br-sm">
                                                <figure>
                                                    <img src="{{ asset('assets/images/shop/banner3.jpg') }}"
                                            ...
                                            <div class="swiper nav-top">
                                                <div class="swiper-container swiper-theme nav-top"
                                                    ...
                                                    <div class="swiper-wrapper">
                                                        @foreach ($latestProduct->chunk(3) as $chunk)
