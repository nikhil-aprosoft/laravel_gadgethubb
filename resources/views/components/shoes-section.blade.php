    ...
    <div class="row">
        <div class="col-lg-3 col-md-4 col-sm-12 mb-4">
            <div class="banner h-100 br-sm"
                ...
                <div class="banner-content content-top p-4">
                        ...
                        <div class="swiper-slide product-col">
                            <div class="product-wrap product text-center">
                                <figure class="product-media">
                                    <a href="{{ route('product-details', $shoe->slug) }}">
                                        <img src="{{ asset($shoe->thumbnail) }}" alt="{{ $shoe->product_name }}"
                                            class="img-fluid" width="216" height="243" />
                                    </a>
                                ...
                                <div class="product-details">
                                    <h4 class="product-name"><a
                                            href="{{ route('product-details', $shoe->slug) }}">{{ $shoe->product_name }}</a>
                                    </h4>
